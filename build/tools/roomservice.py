...
custom_dependencies = "rice.dependencies"
org_manifest = "RiceDroid"  # leave empty if org is provided in manifest
org_display = "riceDroid Android"  # needed for displaying
...
def main():
    ...
    for repository in repositories:
        ...
        adding = [{'repository': "Creative-OS/" + repo_name, 'target_path': repo_path}]
